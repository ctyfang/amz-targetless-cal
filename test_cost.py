...
# load pointcloud
with open('pc_edge_scores.npy', 'rb') as f:
    pcs_edge_scores = np.load(f)
with open('pc_edge_idx.npy', 'rb') as f:
...
if SHOW:
    img_with_point = draw_points(img.imgs, ptCloud[pcs_edge_idxs])
...
cost = cost(rot_vec, tra_vec, camera_matrix, 120, ptCloud[pcs_edge_idxs], pcs_edge_scores[pcs_edge_idxs], img.imgs_edges, img.imgs_edge_scores)
print(cost)
print('Done')